...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE login SET uname=%s, upass=%s, myname=%s, conpass=%s, gender=%s, age=%s, email=%s, tel=%s WHERE id=%s",
  ...
  $Result1 = mysql_query($updateSQL, $con_kim) or die(mysql_error());
...
$Recordset1 = mysql_query($query_Recordset1, $con_kim) or die(mysql_error());
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="uname" value="<?php echo htmlentities($row_Recordset1['uname'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Upass:</td>
      <td><input type="text" name="upass" value="<?php echo htmlentities($row_Recordset1['upass'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="conpass" value="<?php echo htmlentities($row_Recordset1['conpass'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="tel" value="<?php echo htmlentities($row_Recordset1['tel'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
